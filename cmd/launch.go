...
var launchCmd = &cobra.Command{
	Use:   "launch",
	Short: "Launch the NUM8 API service, indicating the IP address and port to bind.",
...
func init() {
	...
	launchCmd.Flags().Int("port", 8003, "Port bind to the service. By default, it will listen to port 8003.")
